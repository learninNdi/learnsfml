...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        for (int i = 0; i < balls.size(); i++)
        {
            ...
            // if (balls[i].getPosition().x >= SCR_WIDTH - (2 * circleRadius))
            // {
            //     if (ballDir[i] == 0 || ballDir[i] == 360)
            //         ballDir[i] = 180;
            //     else if (ballDir[i] > 0 && ballDir[i] < 90)
            //         ballDir[i] = 180 - ballDir[i];
            //     else if (ballDir[i] > 270 && ballDir[i] < 360)
            //         ballDir[i] = 180 + (ballDir[i] - 270);
            // }
            // else if (balls[i].getPosition().y >= SCR_HEIGHT - (2 * circleRadius))
            // {
            //     if (ballDir[i] == 90)
            //         ballDir[i] = 270;
            //     else if (ballDir[i] > 0 && ballDir[i] < 90)
            //         ballDir[i] = 360 - ballDir[i];
            //     else if (ballDir[i] > 90 && ballDir[i] < 180)
            //         ballDir[i] = 180 + (ballDir[i] - 90);
            // }
            // else if (balls[i].getPosition().x <= 0)
            // {
            //     if (ballDir[i] == 180)
            //         ballDir[i] = 0;
            //     else if (ballDir[i] > 180 && ballDir[i] < 270)
            //         ballDir[i] = 270 + (ballDir[i] - 180);
            //     else if (ballDir[i] > 90 && ballDir[i] < 180)
            //         ballDir[i] = 90 - (ballDir[i] - 90);
            // }
            // else if (balls[i].getPosition().y <= 0)
            // {
            //     if (ballDir[i] == 270)
            //         ballDir[i] = 90;
            //     else if (ballDir[i] > 180 && ballDir[i] < 270)
            //         ballDir[i] = 180 - (ballDir[i] - 180);
            //     else if (ballDir[i] > 270 && ballDir[i] < 360)
            //         ballDir[i] = 360 - ballDir[i];
            // }
            ...
            if (balls[i].getPosition().x >= SCR_WIDTH - (2 * circleRadius))
            {
                if (ballDir[i] == 0 || ballDir[i] == 360)
                    ...
                    ballDir[i] = 90 + (90 - ballDir[i]);
                else if (ballDir[i] > 270 && ballDir[i] < 360)
                    ballDir[i] = 270 - (ballDir[i] - 270);
            }
            else if (balls[i].getPosition().y >= SCR_HEIGHT - (2 * circleRadius))
            {
                if (ballDir[i] == 90)
